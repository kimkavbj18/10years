...
*/
var footer = document.getElementById('footer-bf');
var footerTemplate = `<div class="container-bf">
                <div class="row-bf footer-menus">
                ...
                <div class="row-bf footer-info">
                    <div class="col-lg-6">
                        <div class="logo-nerdcom"><a href="https://nerdcom.host"><img src="https://www.nerdcom.host/images/logon.png" alt="anerdcom" class="img-fluid"></a></div>
                    ...
                    <div class="col-lg-6">
                        <ul class="footer-menu-icons nav-bf list-unstyled">
                            <li class="nav-item">
                            </li>
                            <li class="nav-item"><a href="../comming-soon.html"><img src="https://www.nerdcom.host/images/visa.svg" alt="pay"></a></li>
                            <li class="nav-item"><a href="../comming-soon.html"><img src="https://www.nerdcom.host/images/mastercard.svg" alt="pay"></a></li>
                            <li class="nav-item"><a href="../comming-soon.html"><img src="https://www.nerdcom.host/images/amex.svg" alt="pay"></a></li>
                        </ul>
                        <ul class="footer-menu-links nav-bf list-unstyled">
...
*/
var header = document.getElementById('header-bf');
var headerTemplate = `<div class="container-bf">
                <div class="row-bf">
                    <div class="container-fluid-bf">
                        ...
                        <div class="logo-nerdcom">
                            <a href="https://nerdcom.host"><img src="https://www.nerdcom.host/images/logon.png" alt="anerdcom" class="img-fluid"></a>
                        </div>
                        <div class="logo-white">
                            <a href="https://nerdcom.host"><img src="https://www.nerdcom.host/images/logob.png" alt="bnerdcom" class="img-fluid"></a>
                        </div>
                        <nav class="navigation nav-item hide-desktop">
                            <ul class="secondary-menu list-unstyled nav-bf">
                            ...
                            <ul class="main-menu list-unstyled nav-bf">
                                <li class="nav-item">
                                        ...
                                        <ul class="menu list-unstyled">
                                            <li>
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li><a class="link-title-company" href="https://www.nerdcom.host/kai/">KAI  <img src="https://www.nerdcom.host/images/kai.png" alt="nerdcom_kai"></a></li>
                                                </ul>
                                            </li>
                                            <li>
                                    ...
                                    <div class="sub-menu">
                                        <ul class="menu list-unstyled">
                                            <li class="text-left  text-lg-center">
                                                ...
                                                <img class="nav-img-contact hide-mobile" src="https://www.nerdcom.host/images/supp.svg" alt="support">
                                            </li>
                                            <li class="text-left text-lg-center">
                                                <a class="link-title-center" href="https://www.nerdcom.host/questions/">Realiza una pregunta</a>
                                                <img class="nav-img-contact hide-mobile" src="https://www.nerdcom.host/images/quest.svg" alt="quest">
                                            </li>
                                            <li class="text-left text-lg-center">
                                                <a class="link-title-center" target="_new" href="https://panel.nerdcom.host/knowledgebase">Preguntas frecuentes</a>
                                                <img class="nav-img-contact hide-mobile" src="https://www.nerdcom.host/images/faq.svg" alt="faq">
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="text-center nav-item">
                                    <a href="../comming-soon.html" class="btn-bf btn-blk-mobile nav-offers btn-sm">Ofertas</a>
                                </li>
                                    ...
                                    <div class="sub-menu worldwide-menu">
                                        <ul class="menu list-unstyled">
                                            <li>
                                                <span>América</span>
                                                <ul class="list-unstyled">
                                                    <li><a href="../comming-soon.html"><img class="flags" src="https://www.nerdcom.host/images/usa.png" alt="usa"> USA</a></li>
                                                    <li><a href="../comming-soon.html"><img class="flags" src="https://www.nerdcom.host/images/republicadominicana.png" alt="rep_dominicana"> R. Dominicana</a></li>
                                                    <!-- <li><a href="../comming-soon.html"><img class="flags" src="https://www.nerdcom.host/images/argentina.png" alt="argentina"> Argentina</a></li>
                                                    <li><a href="../comming-soon.html"><img class="flags" src="https://www.nerdcom.host/imagesmex.png" alt="mexico"> México</a></li>
                                                    <li><a href="../comming-soon.html"><img class="flags" src="https://www.nerdcom.host/images/chile.png" alt="chile"> Chile</a></li>
                                                    <li><a href="../comming-soon.html"><img class="flags" src="https://www.nerdcom.host/images/venezuela.png" alt="venezuela"> Venezuela</a></li> -->
                                                </ul>
                                            </li>
                                            <!-- <li>
                                                <span>Europa</span>
